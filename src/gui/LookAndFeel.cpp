...
KloudSauceLookAndFeel::KloudSauceLookAndFeel()
{
...
juce::Font KloudSauceLookAndFeel::getLabelFont (juce::Label& label)
{
...
//==============================================================================
void KloudSauceLookAndFeel::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height,
...
//==============================================================================
void KloudSauceLookAndFeel::drawToggleButton (juce::Graphics& g, juce::ToggleButton& button,
